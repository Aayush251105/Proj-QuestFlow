    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // create collection
                return [4 /*yield*/, config_1.databases.createCollection(name_1.db, name_1.answerCollection, name_1.answerCollection, [
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all([
                            config_1.databases.createStringAttribute(name_1.db, name_1.answerCollection, "content", 10000, true),
                            config_1.databases.createStringAttribute(name_1.db, name_1.answerCollection, "questionId", 50, true),
                            config_1.databases.createStringAttribute(name_1.db, name_1.answerCollection, "authorId", 50, true),
                        ])];
                case 2:
                    // creating attributes and indexes
                    _a.sent();
